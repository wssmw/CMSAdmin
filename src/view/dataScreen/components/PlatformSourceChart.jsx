...
const PlatformSourceChart = memo(() => {
    let platFromData = [
        {
            value: 40,
            name: "智慧文旅平台",
    ...
    useEffect(() => {
        ...
        var myChart = echarts.init(document.querySelector(".PlatformSourceChart_main"));
        // 绘制图表
  ...
  return (
    <div style={{width:"100%",height:"100%"}}>
      <div className="PlatformSourceChart_main" style={{width:"100%",height:"100%"}}></div>  
    </div>
  )
})
